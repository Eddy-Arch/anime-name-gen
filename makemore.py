...
if __name__ == '__main__':
    ...
    while True:
        ...
        if step % 10 == 0:
            ...
            loss_data_value = loss.item()
            step_number = step
            log_dir = args.input_file.split('/')[1].split('.')[0]
            with open(f"data/{log_dir}/loss.txt", "a") as file:
                file.write(str(loss_data_value)+"\n")
            with open(f"data/{log_dir}/step.txt", "a") as file:
                file.write(str(step_number)+"\n")
